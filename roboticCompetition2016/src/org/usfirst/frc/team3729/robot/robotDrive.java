...
public class robotDrive {
	...
	AnalogGyro gyro;
	double circumference = 7.5 * 3. / 12;
	...
	private void DriveStraight(double speed, double currentheading) {
		...
		if (angle >= currentheading + .05) {
			LeftMotor1.set(speed * .5);
			LeftMotor2.set(speed * .5);
